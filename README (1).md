...
De app is gebouwd rond een 5-daagse krachtsplit met geïntegreerde cardio en cut-macro's, gericht op lean blijven met progressie op kracht en volume.
...
| Dinsdag | Pull | Rug, achterdelts, biceps |
| Woensdag | Legs | Quads, hamstrings, kuiten |
| Donderdag | Upper | Tweede borstdag met incline-nadruk, plus rug, delts en armen |
| Vrijdag | Lower | Squat-patroon, unilateraal en detailwerk |
| Zaterdag | Conditie en Cardio | HIIT-intervallen, eventueel met Zone 2 erachteraan |
| Zondag | Rust | Herstel |

De meeste krachtdagen eindigen met een optionele Zone 2 cardio. De beendagen houden bewust afstand van pittige cardio, zodat je benen vol inzetbaar blijven.
